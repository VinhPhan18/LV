...
<form role="form" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                <div class="form-group "> 
                    ...
                    <input type="text" class="form-control" name="a_name" placeholder="Tên bài viết...." autocomplete="off" value="{{  $article->a_name ?? old('a_name') }}"> 
    ...
    <div class="col-sm-12 clearfix">
        <div class="box-footer text-center"> 
            <a href="{{ route('admin.article.index') }}" class="btn btn-default"><i class="fa fa-close"></i> Đóng</a> 
            <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> {{ isset($article) ? "Cập nhật" : "Lưu" }} </button> </div>
    </div>
</form>
