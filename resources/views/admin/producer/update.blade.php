                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('pdr_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{  old('pdr_name', isset($producer->pdr_name) ? $producer->pdr_name : '') }}" name="pdr_name"  placeholder="Tên...">
                            ...
                            <div class="form-group {{ $errors->first('pdr_phone') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{  old('pdr_phone', isset($producer->pdr_phone) ? $producer->pdr_phone : '') }}" name="pdr_phone"  placeholder="Số điện thoại...">
