                                ...
                                @if (isset($producers))
                                    @foreach($producers as $key => $producer)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.producer.update', $producer->id) }}" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i> Chỉnh sửa</a>
                                                <a href="{{  route('admin.producer.delete', $producer->id) }}" class="btn btn-xs btn-danger js-delete-confirm"><i class="fa fa-trash"></i>Xóa</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
