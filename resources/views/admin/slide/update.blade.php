                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('sd_title') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ $slide->sd_title }}" name="sd_title"  placeholder="Tên banner...">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group {{ $errors->first('sd_link') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="sd_link" value="{{ $slide->sd_link}}"  placeholder="Sao chép đường link sản phẩm...">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="sd_sort" value="{{ $slide->sd_sort }}" placeholder="Vị trí banner...">
