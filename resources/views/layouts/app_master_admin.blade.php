        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="/" class="logo">
                    ...
                    <span class="logo-mini"><b>THE</b>Hin ut</span>
...
{{--                            </li>--}}
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li><a href="{{  route('admin.event.index') }}"><i class="fa fa-calendar" aria-hidden="true"></i><span>Quản lý sự kiện</span></a></li>
                        <li><a href="{{  route('admin.slide.index') }}"><i class="fa fa-calendar-minus-o" aria-hidden="true"></i><span>Quản lý banner</span></a></li>
                        <li><a href="{{  route('admin.static.index') }}"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> <span>Quản lý trang</span></a></li>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2023 <a href="https://adminlte.io">Nguyễn Thị Hồng Gấm</a>.</strong>Đã đăng ký Bản quyền.
            </footer>
            <!-- Control Sidebar -->
