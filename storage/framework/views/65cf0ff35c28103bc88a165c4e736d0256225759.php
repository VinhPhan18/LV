                                ...
                                <?php if(isset($statics)): ?>
                                    <?php $__currentLoopData = $statics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $static): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.static.update', $static->id)); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i>Chỉnh sửa </a>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\THE CIINDYS\THE CIINDYS\resources\views/admin/static/index.blade.php ENDPATH**/ ?>