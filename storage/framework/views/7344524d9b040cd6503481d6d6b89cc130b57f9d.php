                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($product->pro_sale): ?>
                                                    <span style="text-decoration: line-through;"><?php echo e(number_format($product->pro_price,0,',','.')); ?> đ</span><br>
                                                    <?php 
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?> 
                                                    <a href="<?php echo e(route('admin.product.hot', $product->id)); ?>" class="label label-default">Không có</a>
                                                <?php endif; ?>
                                            </td>
                                            <td><?php echo e(($product->pro_number - $product->pro_pay) > 0 ? $product->pro_number - $product->pro_pay : 0); ?></td>
                                            <td>
                                                <?php if($product->pro_active == 1): ?>
                                                    <a href="<?php echo e(route('admin.product.active', $product->id)); ?>" class="label label-info">Kích hoạt</a>
                                                <?php else: ?> 
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.product.update', $product->id)); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i>Chinh sửa</a>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\THE CIINDYS\resources\views/admin/product/index.blade.php ENDPATH**/ ?>